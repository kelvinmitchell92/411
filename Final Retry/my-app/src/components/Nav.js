...
import useDarkMode from 'C:/Users/Sassy/IST411/Final Retry/my-app/src/hooks/useDarkMode.js'
...
<div className='fixed top-4'>
  <span onClick={() => setTheme(colorTheme)} className = 'w-6 h-6 bg-red-100 rounded-full  cursor-pointer text-white flex justify-center'>
    {colorTheme === 'light' ?(
